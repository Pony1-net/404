...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.instance-3', { style: 'zoom-out', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-6', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
